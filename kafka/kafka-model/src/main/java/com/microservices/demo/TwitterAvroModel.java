...
public class TwitterAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5533568513668583933L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TwitterAvroModel\",\"namespace\":\"com.microservices.demo\",\"fields\":[{\"name\":\"userId\",\"type\":\"string\"},{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"text\",\"type\":[\"null\",\"string\"]},{\"name\":\"createdAt\",\"type\":[\"null\",\"long\"],\"logicalType\":[\"null\",\"date\"]}]}");
   ...
   */
  public TwitterAvroModel(java.lang.CharSequence userId, java.lang.Long id, java.lang.CharSequence text, java.lang.Long createdAt) {
    this.userId = userId;
    this.id = id;
    this.text = text;
   ...
   */
  public static com.microservices.demo.TwitterAvroModel.Builder newBuilder() {
    return new com.microservices.demo.TwitterAvroModel.Builder();
  }
   ...
   * @return A new TwitterAvroModel RecordBuilder
   */
  public static com.microservices.demo.TwitterAvroModel.Builder newBuilder(com.microservices.demo.TwitterAvroModel.Builder other) {
    if (other == null) {
      return new com.microservices.demo.TwitterAvroModel.Builder();
    } else {
      return new com.microservices.demo.TwitterAvroModel.Builder(other);
    }
  }
   ...
   * @return A new TwitterAvroModel RecordBuilder
   */
  public static com.microservices.demo.TwitterAvroModel.Builder newBuilder(com.microservices.demo.TwitterAvroModel other) {
    if (other == null) {
      return new com.microservices.demo.TwitterAvroModel.Builder();
    } else {
      return new com.microservices.demo.TwitterAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TwitterAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.microservices.demo.TwitterAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.microservices.demo.TwitterAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.userId)) {
        this.userId = data().deepCopy(fields()[0].schema(), other.userId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservices.demo.TwitterAvroModel.Builder setUserId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservices.demo.TwitterAvroModel.Builder clearUserId() {
      userId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservices.demo.TwitterAvroModel.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservices.demo.TwitterAvroModel.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservices.demo.TwitterAvroModel.Builder setText(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservices.demo.TwitterAvroModel.Builder clearText() {
      text = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservices.demo.TwitterAvroModel.Builder setCreatedAt(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.microservices.demo.TwitterAvroModel.Builder clearCreatedAt() {
      createdAt = null;
